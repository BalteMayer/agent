...
from caculator import query_and_calculate as query_and_compute
from utils.condense import condense_msg
from get_db_config import describe_db_info
...
class CustomAgent():
    def __init__(self, name: str, model: str):
        # TODO: remove hardcode api_key and base_url, use environment variables
        ...
        self.swarm_client = Swarm(client)
        ...
        """
        self.functions = [
            self.transmit_refined_params_and_db_info,
            describe_db_info
        ]
    ...
    def transmit_refined_params_and_db_info(self, time_info: str, chart_info: str):
        ...
        assistant = self.swarm_client.run(
            agent = hazuki,
...
if __name__ == '__main__':
    ...
    agent = CustomAgent(name="Agent Main", model="gpt-4o-mini")
    agent = agent.swarm_client.run(
        agent=agent.agent,
